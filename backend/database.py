...
def init_db():
    from models import DriveFile, Report, Watchlist, WatchlistGroup, FuturesChip, Stock, DailyArticle, SyncLog, InviteCode, RecommendationCache, StockRecommendationReason  # noqa: F401
